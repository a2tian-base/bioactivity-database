...
def run_pipeline(
    ...
    *,
    ...
    def process_rows(rows: list[dict], cur) -> None:
        ...
        write_legacy_ic50 = endpoint_key == DEFAULT_ENDPOINT_KEY
        ...
        for row in enriched_rows:
            ...
            try:
                ...
                # dual-write for the hERG compatibility endpoint while
                # bioactivity_results is the primary endpoint result store.
                # Do not broaden this without an explicit data migration plan
                # for existing IC50 consumers.
